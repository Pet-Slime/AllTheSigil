...
namespace voidSigils
{
	public partial class Plugin
	{
		...
		private void AddLeadBones()
		{
			...
			const string LearnDialogue = "ou can lead  a horse to water...";
			Texture2D tex_a1 = SigilUtils.LoadTextureFromResource(Artwork.void_lead_bones);
			...
			var test = SigilUtils.CreateAbilityWithDefaultSettings(rulebookName, rulebookDescription, typeof(void_Lead_Bone), tex_a1, tex_a2, LearnDialogue,
																					true, powerlevel, LeshyUsable, part1Shops, canStack);

			test.activated = true;

			test.pixelIcon = SigilUtils.LoadSpriteFromResource(Artwork.void_lead_bones_a2);
