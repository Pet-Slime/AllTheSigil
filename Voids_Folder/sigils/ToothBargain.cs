...
namespace voidSigils
{
	...
	public class void_Toothpicker : AbilityBehaviour
	{
		...
		public override IEnumerator OnPreDeathAnimation(bool wasSacrifice)
		{
			...
			yield return base.PreSuccessfulTriggerSequence();
			yield return new WaitForSeconds(0.25f);
			yield return Singleton<LifeManager>.Instance.ShowDamageSequence(2, 2, true, 0.25f, ResourceBank.Get<GameObject>("Prefabs/Environment/ScaleWeights/Weight_RealTooth"), 0f);
			yield return new WaitForSeconds(0.25f);
			yield return base.LearnAbility(0.25f);
			yield return new WaitForSeconds(0.25f);
			yield break;
